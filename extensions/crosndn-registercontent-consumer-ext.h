...
#ifndef CRoSNDN_REGISTER_CONTENT_CONSUMER_EXT_H_
#define CRoSNDN_REGISTER_CONTENT_CONSUMER_EXT_H_
...
class CRoSNDNRegisterContentConsumerExt : public ndn::App
{
public:
  ...
  CRoSNDNRegisterContentConsumerExt ();
