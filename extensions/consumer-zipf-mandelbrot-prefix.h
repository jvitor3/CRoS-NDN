...
#ifndef CONSUMER_ZIPF_MANDELBROT_PREFIX_H_
#define CONSUMER_ZIPF_MANDELBROT_PREFIX_H_
 ...
 */
class ConsumerZipfMandelbrotPrefix: public ConsumerCbr
{
public:
   ...
   */
  ConsumerZipfMandelbrotPrefix ();
  virtual ~ConsumerZipfMandelbrotPrefix ();
...
private:
  ...
  std::map<uint32_t,uint32_t> m_seqmap; // seq,prefix; 
};

} /* namespace ndn */
} /* namespace ns3 */
#endif /* NDN_CONSUMER_ZIPF_MANDELBROT_PREFIX_H_ */
