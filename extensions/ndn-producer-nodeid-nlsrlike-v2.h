...
#ifndef NDN_PRODUCER_NODEID_NLSRLIKE_V2_H
#define NDN_PRODUCER_NODEID_NLSRLIKE_V2_H
...
class ProducerNodeIDNLSRLikeV2 : public App
{
public: 
  static TypeId
  GetTypeId (void);
        
  ProducerNodeIDNLSRLikeV2 ();
...
#endif // NDN_PRODUCER_NODEID_NLSRLIKE_V2_H
