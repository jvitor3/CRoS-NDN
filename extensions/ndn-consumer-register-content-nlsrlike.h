...
#ifndef NDN_CONSUMER_REGISTER_CONTENT_NLSRLIKE_H
#define NDN_CONSUMER_REGISTER_CONTENT_NLSRLIKE_H
...
class ConsumerRegisterContentNLSRLike : public ndn::App
{
public:
  ...
  ConsumerRegisterContentNLSRLike ();
