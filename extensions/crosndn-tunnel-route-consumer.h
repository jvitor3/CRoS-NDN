...
#ifndef CRoSNDN_TUNNEL_ROUTE_CONSUMER_H
#define CRoSNDN_TUNNEL_ROUTE_CONSUMER_H
...
class CRoSNDNTunnelRouteConsumer : public App
{
public: 
  static TypeId
  GetTypeId (void);
        
  CRoSNDNTunnelRouteConsumer ();
...
#endif // CRoSNDN_TUNNEL_ROUTE_CONSUMER_H
