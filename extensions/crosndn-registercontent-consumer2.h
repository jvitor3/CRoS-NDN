...
#ifndef CRoSNDN_REGISTER_CONTENT_CONSUMER2_H_
#define CRoSNDN_REGISTER_CONTENT_CONSUMER2_H_
...
class CRoSNDNRegisterContentConsumer2 : public ndn::App
{
public:
  ...
  CRoSNDNRegisterContentConsumer2 ();
