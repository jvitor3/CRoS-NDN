...
#ifndef NDN_STACK_HELPER_2_H
#define NDN_STACK_HELPER_2_H
...
public:
  /**
   * \brief Create a new NdnStackHelper2 with a default NDN_FLOODING forwarding stategy
   */
  StackHelper2();

  /**
   * \brief Destroy the NdnStackHelper2
   */
  virtual ~StackHelper2 ();
  ...
  void
  SetDefaultPrefix (std::string prefix);
...
private:
  StackHelper2 (const StackHelper2 &);
  StackHelper2 &operator = (const StackHelper2 &o);
...
private:
  ...
  std::string m_prefixdefault;
};

} // namespace ndn
} // namespace ns3

#endif /* NDN_STACK_HELPER_2_H */
