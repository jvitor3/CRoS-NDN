...
#ifndef CRoSNDN_REGISTER_CONTENT_CONSUMER_H_
#define CRoSNDN_REGISTER_CONTENT_CONSUMER_H_
...
class CRoSNDNRegisterContentConsumer : public ndn::App
{
public:
  ...
  CRoSNDNRegisterContentConsumer ();
