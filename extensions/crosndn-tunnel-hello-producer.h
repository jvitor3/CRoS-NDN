...
#ifndef CRoSNDN_TUNNEL_HELLO_PRODUCER_H
#define CRoSNDN_TUNNEL_HELLO_PRODUCER_H
...
class CRoSNDNTunnelHelloProducer : public App
{
public: 
  static TypeId
  GetTypeId (void);
        
  CRoSNDNTunnelHelloProducer ();
...
#endif // CRoSNDN_TUNNEL_HELLO_PRODUCER_H
