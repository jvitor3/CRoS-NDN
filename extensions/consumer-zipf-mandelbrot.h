...
#ifndef CONSUMER_ZIPF_MANDELBROT_H_
#define CONSUMER_ZIPF_MANDELBROT_H_
 ...
 */
class ConsumerZipfMandelbrotB: public ConsumerCbr
{
public:
   ...
   */
  ConsumerZipfMandelbrotB ();
  virtual ~ConsumerZipfMandelbrotB ();
