...
NS_LOG_COMPONENT_DEFINE ("ndn.StackHelper2");

namespace ns3 {
namespace ndn {

StackHelper2::StackHelper2 ()
  : m_limitsEnabled (false)
  , m_needSetDefaultRoutes (false)
  , m_prefixdefault ("/floodingprefix")
{
  ...
  m_netDeviceCallbacks.push_back (std::make_pair (PointToPointNetDevice::GetTypeId (), MakeCallback (&StackHelper2::PointToPointNetDeviceCallback, this)));
...
void
StackHelper2::SetStackAttributes (const std::string &attr1, const std::string &value1,
...
void
StackHelper2::SetForwardingStrategy (const std::string &strategy,
...
void
StackHelper2::SetContentStore (const std::string &contentStore,
                              const std::string &attr1, const std::string &value1,
                              const std::string &attr2, const std::string &value2,
                              const std::string &attr3, const std::string &value3,
                              const std::string &attr4, const std::string &value4)
...
void
StackHelper2::SetPit (const std::string &pitClass,
                     const std::string &attr1, const std::string &value1,
                     const std::string &attr2, const std::string &value2,
                     const std::string &attr3, const std::string &value3,
                     const std::string &attr4, const std::string &value4)
...
void
StackHelper2::SetFib (const std::string &fibClass,
                     const std::string &attr1, const std::string &value1,
                     const std::string &attr2, const std::string &value2,
                     const std::string &attr3, const std::string &value3,
                     const std::string &attr4, const std::string &value4)
...
void
StackHelper2::SetDefaultRoutes (bool needSet)
{
...
void
StackHelper2::SetDefaultPrefix (std::string prefix)
{
  NS_LOG_FUNCTION (this << prefix);
  m_prefixdefault = prefix;
}

void
StackHelper2::EnableLimits (bool enable/* = true*/,
...
Ptr<FaceContainer>
StackHelper2::Install (const NodeContainer &c) const
{
...
Ptr<FaceContainer>
StackHelper2::InstallAll () const
{
  return Install (NodeContainer::GetGlobal ());
}

Ptr<FaceContainer>
StackHelper2::Install (Ptr<Node> node) const
{
  ...
  if (node->GetObject<L3Protocol> () != 0)
    {
      NS_FATAL_ERROR ("StackHelper2::Install (): Installing "
      ...
      if (m_needSetDefaultRoutes)
        {
          ...
          AddRoute (node, m_prefixdefault, StaticCast<Face> (face), std::numeric_limits<int32_t>::max ());
...
void
StackHelper2::AddNetDeviceFaceCreateCallback (TypeId netDeviceType, StackHelper2::NetDeviceFaceCreateCallback callback)
{
  m_netDeviceCallbacks.push_back (std::make_pair (netDeviceType, callback));
}

void
StackHelper2::UpdateNetDeviceFaceCreateCallback (TypeId netDeviceType, NetDeviceFaceCreateCallback callback)
{
...
void
StackHelper2::RemoveNetDeviceFaceCreateCallback (TypeId netDeviceType, NetDeviceFaceCreateCallback callback)
{
  for (NetDeviceCallbackList::iterator i = m_netDeviceCallbacks.begin (); i != m_netDeviceCallbacks.end (); i++)
    {
      if (i->first == netDeviceType)
...
Ptr<NetDeviceFace>
StackHelper2::DefaultNetDeviceCallback (Ptr<Node> node, Ptr<L3Protocol> ndn, Ptr<NetDevice> netDevice) const
{
...
Ptr<NetDeviceFace>
StackHelper2::PointToPointNetDeviceCallback (Ptr<Node> node, Ptr<L3Protocol> ndn, Ptr<NetDevice> device) const
{
...
Ptr<FaceContainer>
StackHelper2::Install (const std::string &nodeName) const
{
...
void
StackHelper2::AddRoute (Ptr<Node> node, const std::string &prefix, Ptr<Face> face, int32_t metric)
{
...
void
StackHelper2::AddRoute (Ptr<Node> node, const std::string &prefix, uint32_t faceId, int32_t metric)
{
...
void
StackHelper2::AddRoute (const std::string &nodeName, const std::string &prefix, uint32_t faceId, int32_t metric)
{
  Ptr<Node> node = Names::Find<Node> (nodeName);
...
void
StackHelper2::AddRoute (Ptr<Node> node, const std::string &prefix, Ptr<Node> otherNode, int32_t metric)
{
...
void
StackHelper2::AddRoute (const std::string &nodeName, const std::string &prefix, const std::string &otherNodeName, int32_t metric)
{
  Ptr<Node> node = Names::Find<Node> (nodeName);
  NS_ASSERT_MSG (node != 0, "Node [" << nodeName << "] does not exist");
