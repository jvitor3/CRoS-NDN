...
#  geom_errorbar (aes(ymin=ise-ci,ymax=ise+ci), width=4, size=1) +  
  ...
  scale_linetype_manual(name = "Caching at:\n", values=c("solid", "dotdash", "dotted", "dashed", "longdash", "twodash"))+
#  scale_color_discrete(name  = xl) +
#  scale_shape_discrete(name  = "Strategy", solid=FALSE) +
  scale_shape(name  = xl, solid=FALSE)+
...
png (paste("./temp/NScriptsTimeb.png",sep=""), width=500, height=500)
print (g.all)
dev.off ()
